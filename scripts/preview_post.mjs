...
html = html.replace(/src="https:\/\/raw\.githubusercontent\.com\/actsb\/claudefold\/[^"]*\/(posts\/[^"]+\.png)"/g, (m, rel) => { try { return 'src="data:image/png;base64,' + readFileSync(rel).toString('base64') + '"'; } catch { return m; } });
